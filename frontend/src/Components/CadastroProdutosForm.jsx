...
const CadastroProdutosForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "Erro ao criar cadastroProdutos. Verifique o console para mais detalhes."
      );
    }
  };

  return (
    <form className="cadastroProdutos" onSubmit={handleSubmit}>
      <input
        type="text"
        name="nome"
        placeholder="Nome"
      ...
      <input
        ...
        onChange={handleChange}
      />
      <Button variant="Salvar">Salvar</Button>{" "}
    </form>
  );
};
